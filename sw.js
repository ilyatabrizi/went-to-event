...
const SHELL = [
  ...
  './js/router.js', './js/store.js', './js/ui.js', './js/util.js', './js/views/create.js',
  './js/views/detail.js', './js/views/home.js', './js/views/pickers.js',
  './js/views/profile.js', './js/views/went.js', './assets/fonts/inter.woff2',
